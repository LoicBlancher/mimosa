...
function custom_post_recette() {
    $labels = array(
        ...
        'parent_item_colon'   => __( 'Recette parent:', 'html5blank' ),
        'all_items'           => __( 'All Recettes', 'html5blank' ),
        'view_item'           => __( 'View Recette', 'html5blank' ),
        'add_new_item'        => __( 'Add Recette', 'html5blank' ),
        'add_new'             => __( 'Add New', 'html5blank' ),
        'edit_item'           => __( 'Edit Recette', 'html5blank' ),
        'update_item'         => __( 'Update Recette', 'html5blank' ),
        'search_items'        => __( 'Search Recette', 'html5blank' ),
        'not_found'           => __( 'Not Found', 'html5blank' ),
        'not_found_in_trash'  => __( 'Not found in Trash', 'html5blank' ),
    );
