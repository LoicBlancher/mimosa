jQuery(function ($) {
 $(document).ready(function () {
      ...
      function animateHome(id){
         if(id==1){
           TweenLite.to("#ms-logo-mimosa-home", 2, {scale:1, rotation:20 }); 
         }
         else if(id == 2){
         }
      }
             $(".main").onepage_scroll({
                ...
                responsiveFallback: 736,        // You can fallback to normal page scroll by defining the width of the browser in which
